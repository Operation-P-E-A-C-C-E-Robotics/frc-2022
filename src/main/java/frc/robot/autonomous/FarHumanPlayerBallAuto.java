...
public class FarHumanPlayerBallAuto extends SequentialCommandGroup {
    public FarHumanPlayerBallAuto(DriveTrain driveTrain, Flywheel shooter, Hood hood, BallHandler intake, OldTurret turret, Limelight limelight, RobotContainer container){
