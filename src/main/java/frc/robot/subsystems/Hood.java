...
public class Hood extends SubsystemBase {
    ...
    private final double inchesFlywheelToServoBase = 0, //distance between flywheel and fixed mount of servo (for angle)
        inchesFlywheelToServoAttachment = 0, //distance between flywheel and servo attachment to hood (for angle)
    ...
    public void setServoPercent(double position) {
        hoodServo.setSpeed(position); //need to do setSpeed for position cause whatever
    }
